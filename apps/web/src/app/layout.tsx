          ...
          <nav className="container mx-auto px-4 py-3">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-4">
                <button className="hidden md:inline-flex items-center px-1.5 py-1.5 rounded-2xl text-[#002b4c] bg-white hover:bg-[#0dcaf0] font-medium transition-colors cursor-pointer" aria-label="User Profile">
                  <svg
